...
export const ToDo = () => {
  const [todos, setTodos] = useState([
    {id: 1, title: 'First todo', description: 'first todo', date: new Date().getDay() + '.' + new Date().getMonth() + '.'  + new Date().getFullYear() + ' - ' + new Date().getHours() + ':' + new Date().getMinutes(), checked: false},
    {id: 2, title: 'Second todo', description: 'second todo', date: new Date().getDay() + '.' + new Date().getMonth() + '.'  + new Date().getFullYear() + ' - ' + new Date().getHours() + ':' + new Date().getMinutes(), checked: false}
  ]);
